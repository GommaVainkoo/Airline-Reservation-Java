   ...
   void Display_Details(ArrayList<Passanger> al)
	{
		...
		for(Passanger p : al)
		{
			System.out.println(String.format("%-20s%-20s%-20s%-20s%-30s%-30ss",p.Name,p.Dob,p.aadhar,p.phone,p.email_id,p.address));
		}
	}
...
public Reservation(long Ticket_no, String Class,String Mode_type,String FName,String From,String To,String Time,String Date,long Passport_no,long aadhar,String status,String Name){
	...
	int i=0;
					...
					for(Flight f: a2)
					{
						if(Num1 == f.Num)
						{
							...
							try{
								...
								if(fi2.exists())
								{
									...
									a3 = (ArrayList<Reservation>)ois.readObject();
								}
						...
						System.out.println("\nEnter the following details to BOOK TICKET:\n");
								...
								a3.add(new Reservation(Ticket_no,Class,Mode_type,f.FName,f.From,f.To,f.Time,f.Date,Passport_no,p.aadhar,status,Name));
								Reservation r =new Reservation(Ticket_no,Class,Mode_type,f.FName,f.From,f.To,f.Time,f.Date,Passport_no,p.aadhar,status,p.Name); 
...
void Display_Booking(ArrayList<Reservation> a3){
	System.out.println("\n--------------Passanger List---------------\n");
		...
		for(Reservation r : a3)
		{
			System.out.println(String.format("%-20s%-20s%-20s%-20s%-30s%-30ss",r.Ticket_no,r.Class,r.Mode_type,r.FName,r.Name,r.status));
		}
}
		...
		Scanner scn= new Scanner(System.in);
			while(k1==0){
				System.out.println("\n*********Airline Reservation**********\n");
					...
					case 3:ArrayList<Reservation> a3 = new ArrayList<Reservation>();
